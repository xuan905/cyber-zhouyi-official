      ...
      <section id="about" className="mx-auto max-w-[1440px] px-5 py-24 md:px-10 md:py-36 lg:px-14">
        <div className="grid grid-cols-1 gap-12 md:grid-cols-[0.35fr_0.65fr] md:gap-16">
          ...
          <div className="grid grid-cols-1 gap-12 lg:grid-cols-[1fr_0.72fr] lg:items-center">
            <div className="max-w-3xl"><h2 className="font-serif text-4xl leading-tight tracking-[-0.03em] sm:text-6xl">{copy.storyTitle}</h2><p className="mt-8 max-w-2xl text-base leading-8 text-muted-foreground">{copy.storyBody}</p><Link href="/guide" className="mt-8 inline-flex items-center gap-2 border-b border-foreground/30 pb-2 text-sm font-semibold text-foreground hover:border-[color:var(--accent)] hover:text-[color:var(--accent)] dark:hover:border-[color:var(--gold)] dark:hover:text-[color:var(--gold)]">{copy.secondary}<MoveUpRight className="size-4" /></Link><div className="mt-10 h-px w-32 bg-foreground/30" /></div>
